...
// Look at this list for company identifiers https://www.bluetooth.org/en-us/specification/assigned-numbers/company-identifiers
...
public class IBeacon {
    ...
    public static IBeacon fromScanData(byte[] scanData, int rssi) {
        ...
        while (startByte <= 5) {
            if (((int)scanData[startByte] & 0xff) == 0x4c &&
                ...
                Log.d(IBeacon.class.getName(), "This is a proprietary Estimate beacon advertisement that does not meet the iBeacon standard.  Identifiers cannot be read.");
                ...
                Log.d(IBeacon.class.getName(), "This is a proprietary Gimbal beacon advertisement that does not meet the iBeacon standard.  Identifiers cannot be read.");
                IBeacon iBeacon = new IBeacon();
                iBeacon.major = 0;
                iBeacon.minor = 0;
                iBeacon.proximityUuid = "00000000-0000-0000-0000-000000000000";
        ...
        if (patternFound == false) {
            ...
            Log.d(IBeacon.class.getName(), "This is not an iBeacon advertisement (no 4c000215 seen in bytes 2-5).  The bytes I see are: "+bytesToHex(scanData));
            return null;
        }
        ...
        iBeacon.proximityUuid = iBeacon.proximityUuid.toUpperCase();
        return iBeacon;
    }
    ...
    public String toString() {
        ...
        sb.append("Major: ").append(major).append("\n")
                ...
                .append("Proximity: ").append(proximity).append("\n")
                .append("RSSI: ").append(rssi).append("\n")
                .append("Major: ").append(major).append("\n")
                .append("Proximity UUId: ").append(proximityUuid).append("\n")
                .append("Tx Power: ").append(txPower).append("\n");
        return sb.toString();
    }
    ...
    protected static double calculateAccuracy(int txPower, double rssi) {
        ...
        Log.d(IBeacon.class.getName(), "calculating accuracy based on rssi of "+rssi);
        ...
        if (ratio < 1.0) {
            ...
            Log.d(IBeacon.class.getName(), " avg rssi: "+rssi+" accuracy: "+accuracy);
            return accuracy;
        }
    }
